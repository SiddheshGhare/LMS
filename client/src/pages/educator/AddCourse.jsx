...
const AddCourse = () => {
  ...
  const [coursePrice ,setCoursePrise]=useState(0)
  ...
  const handleChapter =(action,chapterId)=>{
    if (action === 'add') {
      const title = prompt('emter chapter name :')
      if(title){
      const newChapter ={
        chapterId:uniqid(),
        chapterTitle:title,
      ...
      <form onSubmit={handleSubmit}  className='flex  flex-col gap-4 max-w-md w-full text-gray-500 '>
       ...
       <div className='flex   items-center justify-between flex-wrap'>
         <div className='flex flex-col gap-1 '>
          <p>Course Price</p>
          <input
           onChange={(e)=>setCoursePrise(e.target.value)}
           value={coursePrice}
           type="number"
           placeholder='0'
        ...
        <div>
                      ...
                      <div className="p-4">
                        {
                          chapter.chapterContent.map((lecture,lectureIndex)=>(
                            <div key={lectureIndex} className=' flex justify-between items-center mb-2'>
                              <span>{lectureIndex +1}{lecture.lectureTitle}-{lecture.lectureDuration}mins - <a href={lecture.lectureUrl } target='_blank' className=' text-blue-500'>Link</a> - {lecture.isPreviewFree?
          ...
          {
            showPopUp && (
              <div className='fixed inset-0 flex items-center justify-center bg-blue-800/50'>
                ...
                <div className='mb-2'>
                 ...
                 <div className='mb-2 flex  gap-4 items-center'>
                  <p>Is preview Free</p>
                  <input type="checkbox" 
                  className='mt-1   border rounded py-1 px-2 '
        ...
        <button type='submit' className=' bg-black text-white w-max py-2 px-8 rounded cursor-pointer my-4'> Add</button>
