...
const CourseDetails = () => {
  ...
  return (courseData ?
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-32
    pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>Course By <span className='text-blue-600 underline'>Sid</span></p>
          ...
          <div className='mt-18'>
            ...
            <p className='pt-3  text-gray-600 rich-text '
              dangerouslySetInnerHTML={{
        ...
        {/* right Column */}
        <div className='max-w-[424px] z-10 shadow-[0px_4px_15px_2px_rgba(0,0,0,1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
             ...
             <button className='bg-blue-800 text-white rounded md:mt-6  mt-4 w-full py-3 font-medium'>{isAlreadyEnrolled?"Already Enrolled":'Enroll Now'}</button>
             ...
             <div className='pt-6'>
              ...
              <ul className=' ml-4 pt-2 text-sm md:text-default list-disc text-gray-600'>
                ...
                <li>downloadable resourses and sourcecode </li>
