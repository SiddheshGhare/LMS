...
function CourcesSection() {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <p className='text-sm md:text-base text-gray-500  mt-3'>Discover our top rated courses  accross various categories . From coding and design to business and wellness,  Our courses are creafted to delever results.</p>
